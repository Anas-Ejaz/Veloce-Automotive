...
export default function Login() {
  return (
    <div className='w-full h-[110vh] mb-4 lg:mb-0 items-end lg:h-screen flex justify-center lg:items-center' style={{background: ` linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${loginImg})`, backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat",}}>
      ...
      <div className="rounded-[40px] flex flex-col justify-center px-6 py-6 lg:px-8 lg:w-[450px]" style={{ backgroundColor: 'rgba(20,71,230,0.3)', backdropFilter:'blur(6px)',}}>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form action="#" method="POST" className="space-y-6">
            <div>
              <label for="name" className="block text-sm/6 font-medium text-gray-100">Name</label>
              <div className="mt-2">
