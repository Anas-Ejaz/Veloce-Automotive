...
function Subscription() {
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <p className="absolute text-gray-400 text-l font-medium top-26 pt-5">Depreciation doesn’t matter. Drive without loans, interest, or long-term commitments. Insurance, maintenance, and paperwork are all included, so you stay worry-free. With transparent pricing, generous mileage, and the freedom to swap vehicles anytime, driving has never been this simple or flexible.</p> 
