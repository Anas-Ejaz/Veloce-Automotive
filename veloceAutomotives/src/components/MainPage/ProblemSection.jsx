  ...
  return (
    <div className='relative p-20 bg-black'>
        ...
        <div className='flex justify-center gap-3'>
            <h1 className='text-5xl font-extrabold text-gray-300'>Ownership</h1>
            <h1 className='text-5xl font-extrabold text-blue-500'>&</h1>
            <h1 className='text-5xl font-extrabold text-gray-300'>Leasing</h1>
        </div>
        <div className='pr-28 pl-28 pt-15'>
    <div className='flex overflow-x-auto scroll-smooth gap-6 px-3 no-scrollbar opacity-85'>
